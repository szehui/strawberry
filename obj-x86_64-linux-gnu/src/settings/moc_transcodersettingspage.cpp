...
#include <memory>
#include "../../../src/settings/transcodersettingspage.h"
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_TranscoderSettingsPage_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_TranscoderSettingsPage_t qt_meta_stringdata_TranscoderSettingsPage = {
    {
        QT_MOC_LITERAL(0, 22)   // "TranscoderSettingsPage"
    },
...
Q_CONSTINIT static const uint qt_meta_data_TranscoderSettingsPage[] = {
...
Q_CONSTINIT const QMetaObject TranscoderSettingsPage::staticMetaObject = { {
    QMetaObject::SuperData::link<SettingsPage::staticMetaObject>(),
    qt_meta_stringdata_TranscoderSettingsPage.offsetsAndSizes,
    qt_meta_data_TranscoderSettingsPage,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_TranscoderSettingsPage_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<TranscoderSettingsPage, std::true_type>
    >,
    nullptr
} };
