...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_NetworkAccessManager_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_NetworkAccessManager_t qt_meta_stringdata_NetworkAccessManager = {
    {
        QT_MOC_LITERAL(0, 20)   // "NetworkAccessManager"
    },
...
Q_CONSTINIT static const uint qt_meta_data_NetworkAccessManager[] = {
...
Q_CONSTINIT const QMetaObject NetworkAccessManager::staticMetaObject = { {
    ...
    qt_meta_stringdata_NetworkAccessManager.offsetsAndSizes,
    qt_meta_data_NetworkAccessManager,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_NetworkAccessManager_t,
        // Q_OBJECT / Q_GADGET
