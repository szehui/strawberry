...
Q_CONSTINIT static const qt_meta_stringdata_Application_t qt_meta_stringdata_Application = {
    {
        ...
        QT_MOC_LITERAL(12, 12),  // "ExitFinished"
        QT_MOC_LITERAL(25, 0),  // ""
        QT_MOC_LITERAL(26, 12)   // "ExitReceived"
    },
    "Application",
    "ExitFinished",
    "",
...
void Application::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &Application::ExitFinished; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
