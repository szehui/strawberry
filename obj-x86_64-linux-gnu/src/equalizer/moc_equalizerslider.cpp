...
#include <memory>
#include "../../../src/equalizer/equalizerslider.h"
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_EqualizerSlider_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_EqualizerSlider_t qt_meta_stringdata_EqualizerSlider = {
    {
        QT_MOC_LITERAL(0, 15),  // "EqualizerSlider"
        QT_MOC_LITERAL(16, 12),  // "ValueChanged"
        QT_MOC_LITERAL(29, 0),  // ""
        QT_MOC_LITERAL(30, 5),  // "value"
        QT_MOC_LITERAL(36, 14)   // "OnValueChanged"
    },
    "EqualizerSlider",
    "ValueChanged",
    "",
...
Q_CONSTINIT static const uint qt_meta_data_EqualizerSlider[] = {
...
Q_CONSTINIT const QMetaObject EqualizerSlider::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_meta_stringdata_EqualizerSlider.offsetsAndSizes,
    qt_meta_data_EqualizerSlider,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_EqualizerSlider_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<EqualizerSlider, std::true_type>,
        // method 'ValueChanged'
...
void EqualizerSlider::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (EqualizerSlider::*)(const int );
            if (_t _q_method = &EqualizerSlider::ValueChanged; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void EqualizerSlider::ValueChanged(const int _t1)
{
