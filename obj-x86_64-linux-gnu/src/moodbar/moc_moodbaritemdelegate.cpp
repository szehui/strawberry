...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_MoodbarItemDelegate_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_MoodbarItemDelegate_t qt_meta_stringdata_MoodbarItemDelegate = {
    {
        QT_MOC_LITERAL(0, 19),  // "MoodbarItemDelegate"
        QT_MOC_LITERAL(20, 12),  // "StyleChanged"
        QT_MOC_LITERAL(33, 0),  // ""
        QT_MOC_LITERAL(34, 14)   // "ReloadSettings"
    },
    "MoodbarItemDelegate",
    "StyleChanged",
    "",
...
Q_CONSTINIT static const uint qt_meta_data_MoodbarItemDelegate[] = {
...
Q_CONSTINIT const QMetaObject MoodbarItemDelegate::staticMetaObject = { {
    QMetaObject::SuperData::link<QItemDelegate::staticMetaObject>(),
    qt_meta_stringdata_MoodbarItemDelegate.offsetsAndSizes,
    qt_meta_data_MoodbarItemDelegate,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_MoodbarItemDelegate_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<MoodbarItemDelegate, std::true_type>,
        // method 'StyleChanged'
...
void MoodbarItemDelegate::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (MoodbarItemDelegate::*)();
            if (_t _q_method = &MoodbarItemDelegate::StyleChanged; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void MoodbarItemDelegate::StyleChanged()
{
