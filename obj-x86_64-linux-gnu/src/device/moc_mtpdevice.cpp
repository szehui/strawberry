...
#include <memory>
#include "../../../src/device/mtpdevice.h"
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_MtpDevice_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_MtpDevice_t qt_meta_stringdata_MtpDevice = {
    {
        QT_MOC_LITERAL(0, 9),  // "MtpDevice"
        QT_MOC_LITERAL(10, 12),  // "LoadFinished"
        QT_MOC_LITERAL(23, 0),  // ""
        QT_MOC_LITERAL(24, 7),  // "success"
        QT_MOC_LITERAL(32, 14),  // "MtpConnection*"
        QT_MOC_LITERAL(47, 10),  // "connection"
        QT_MOC_LITERAL(58, 11),  // "LoaderError"
        QT_MOC_LITERAL(70, 7),  // "message"
        QT_MOC_LITERAL(78, 3),  // "url"
        QT_MOC_LITERAL(82, 13),  // "DeviceLister*"
        QT_MOC_LITERAL(96, 6),  // "lister"
        QT_MOC_LITERAL(103, 9),  // "unique_id"
        QT_MOC_LITERAL(113, 14),  // "DeviceManager*"
        QT_MOC_LITERAL(128, 14),  // "device_manager"
        QT_MOC_LITERAL(143, 22),  // "SharedPtr<TaskManager>"
        QT_MOC_LITERAL(166, 12),  // "task_manager"
        QT_MOC_LITERAL(179, 19),  // "SharedPtr<Database>"
        QT_MOC_LITERAL(199, 8),  // "database"
        QT_MOC_LITERAL(208, 26),  // "SharedPtr<TagReaderClient>"
        QT_MOC_LITERAL(235, 16),  // "tagreader_client"
        QT_MOC_LITERAL(252, 27),  // "SharedPtr<AlbumCoverLoader>"
        QT_MOC_LITERAL(280, 17),  // "albumcover_loader"
        QT_MOC_LITERAL(298, 11),  // "database_id"
        QT_MOC_LITERAL(310, 10),  // "first_time"
        QT_MOC_LITERAL(321, 6)   // "parent"
    },
    "MtpDevice",
    "LoadFinished",
    "",
...
Q_CONSTINIT static const uint qt_meta_data_MtpDevice[] = {
...
Q_CONSTINIT const QMetaObject MtpDevice::staticMetaObject = { {
    QMetaObject::SuperData::link<ConnectedDevice::staticMetaObject>(),
    qt_meta_stringdata_MtpDevice.offsetsAndSizes,
    qt_meta_data_MtpDevice,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_MtpDevice_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<MtpDevice, std::true_type>,
        // method 'LoadFinished'
...
void MtpDevice::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::CreateInstance) {
        switch (_id) {
        case 0: { MtpDevice *_r = new MtpDevice((*reinterpret_cast< std::add_pointer_t<QUrl>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<DeviceLister*>>(_a[2])),(*reinterpret_cast< std::add_pointer_t<QString>>(_a[3])),(*reinterpret_cast< std::add_pointer_t<DeviceManager*>>(_a[4])),(*reinterpret_cast< std::add_pointer_t<SharedPtr<TaskManager>>>(_a[5])),(*reinterpret_cast< std::add_pointer_t<SharedPtr<Database>>>(_a[6])),(*reinterpret_cast< std::add_pointer_t<SharedPtr<TagReaderClient>>>(_a[7])),(*reinterpret_cast< std::add_pointer_t<SharedPtr<AlbumCoverLoader>>>(_a[8])),(*reinterpret_cast< std::add_pointer_t<int>>(_a[9])),(*reinterpret_cast< std::add_pointer_t<bool>>(_a[10])),(*reinterpret_cast< std::add_pointer_t<QObject*>>(_a[11])));
            if (_a[0]) *reinterpret_cast<QObject**>(_a[0]) = _r; } break;
        case 1: { MtpDevice *_r = new MtpDevice((*reinterpret_cast< std::add_pointer_t<QUrl>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<DeviceLister*>>(_a[2])),(*reinterpret_cast< std::add_pointer_t<QString>>(_a[3])),(*reinterpret_cast< std::add_pointer_t<DeviceManager*>>(_a[4])),(*reinterpret_cast< std::add_pointer_t<SharedPtr<TaskManager>>>(_a[5])),(*reinterpret_cast< std::add_pointer_t<SharedPtr<Database>>>(_a[6])),(*reinterpret_cast< std::add_pointer_t<SharedPtr<TagReaderClient>>>(_a[7])),(*reinterpret_cast< std::add_pointer_t<SharedPtr<AlbumCoverLoader>>>(_a[8])),(*reinterpret_cast< std::add_pointer_t<int>>(_a[9])),(*reinterpret_cast< std::add_pointer_t<bool>>(_a[10])));
            if (_a[0]) *reinterpret_cast<QObject**>(_a[0]) = _r; } break;
        default: break;
        }
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->LoadFinished((*reinterpret_cast< std::add_pointer_t<bool>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<MtpConnection*>>(_a[2]))); break;
