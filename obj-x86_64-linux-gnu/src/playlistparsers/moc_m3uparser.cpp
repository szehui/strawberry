...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_M3UParser_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_M3UParser_t qt_meta_stringdata_M3UParser = {
    {
        QT_MOC_LITERAL(0, 9)   // "M3UParser"
    },
    "M3UParser"
};
...
Q_CONSTINIT static const uint qt_meta_data_M3UParser[] = {
...
Q_CONSTINIT const QMetaObject M3UParser::staticMetaObject = { {
    ...
    qt_meta_stringdata_M3UParser.offsetsAndSizes,
    qt_meta_data_M3UParser,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_M3UParser_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<M3UParser, std::true_type>
    >,
    nullptr
} };
