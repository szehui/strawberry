...
#include <memory>
#include "../../../src/playlistparsers/xmlparser.h"
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_XMLParser_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_XMLParser_t qt_meta_stringdata_XMLParser = {
    {
        QT_MOC_LITERAL(0, 9)   // "XMLParser"
    },
    "XMLParser"
};
...
Q_CONSTINIT static const uint qt_meta_data_XMLParser[] = {
...
Q_CONSTINIT const QMetaObject XMLParser::staticMetaObject = { {
    ...
    qt_meta_stringdata_XMLParser.offsetsAndSizes,
    qt_meta_data_XMLParser,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_XMLParser_t,
        // Q_OBJECT / Q_GADGET
