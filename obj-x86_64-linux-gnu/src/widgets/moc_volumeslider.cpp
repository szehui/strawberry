...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_VolumeSlider_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_VolumeSlider_t qt_meta_stringdata_VolumeSlider = {
    {
        QT_MOC_LITERAL(0, 12),  // "VolumeSlider"
        QT_MOC_LITERAL(13, 13),  // "slotAnimTimer"
        QT_MOC_LITERAL(27, 0)   // ""
    },
    "VolumeSlider",
    "slotAnimTimer",
...
Q_CONSTINIT static const uint qt_meta_data_VolumeSlider[] = {
...
Q_CONSTINIT const QMetaObject VolumeSlider::staticMetaObject = { {
    ...
    qt_meta_stringdata_VolumeSlider.offsetsAndSizes,
