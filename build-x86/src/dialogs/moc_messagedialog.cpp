...
#include <memory>
#include "../../../src/dialogs/messagedialog.h"
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_MessageDialog_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_MessageDialog_t qt_meta_stringdata_MessageDialog = {
    {
        QT_MOC_LITERAL(0, 13),  // "MessageDialog"
        QT_MOC_LITERAL(14, 21),  // "DoNotShowMessageAgain"
        QT_MOC_LITERAL(36, 0)   // ""
    },
    "MessageDialog",
...
Q_CONSTINIT static const uint qt_meta_data_MessageDialog[] = {
...
Q_CONSTINIT const QMetaObject MessageDialog::staticMetaObject = { {
    ...
    qt_meta_stringdata_MessageDialog.offsetsAndSizes,
...
void MessageDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->DoNotShowMessageAgain(); break;
        default: ;
        }
    }
    (void)_a;
